...
async function addTextWatermarkToImage(inputFile, outputFile, text) {
    try {
        ...
        console.log('Znak wodny tekstu został dodany pomyślnie!');
        startApp();
    } catch (error) {
...
async function addImageWatermarkToImage(inputFile, outputFile, watermarkFile) {
    try {
        if (!fs.existsSync(inputFile)) {
            throw new Error('Plik źródłowy nie istnieje!');
        }
        ...
        if (!fs.existsSync(watermarkFile)) {
            throw new Error('Plik znaku wodnego nie istnieje!');
        }
        ...
        console.log('Znak wodny obrazu został dodany pomyślnie!');
        startApp();
    } catch (error) {
        console.error('Wystąpił problem: ', error.message);
        console.log('Spróbuj ponownie.');
